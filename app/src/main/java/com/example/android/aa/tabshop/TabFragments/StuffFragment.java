...
public class StuffFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.shop_stuff_fragment, container, false);
        context = getActivity();
        recyclerview = (RecyclerView) view.findViewById(R.id.shop_stuff_recyclerview);
        pb = (ProgressBar) view.findViewById(R.id.progressBar_shop_stuff);
...
// Do something when expanded
    ...
    private void requestData(String uri) {
        ...
        p.setMethod("POST");
        p.setUri(uri);
        p.setParam("category", "s");
        MyShopStuffAsynk task = new MyShopStuffAsynk();
        task.execute(p);
    }
    ...
    private class MyShopStuffAsynk extends AsyncTask<RequestPackage, String, List<ShopModel>> {
